...
public abstract class BaseProvisioningRequestResourceImpl
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/ai-hub/v1.0/provisioning' -d $'{"accountEntryExternalReferenceCode": ___, "accountEntryName": ___, "tier": ___, "userAccounts": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
...
// LIFERAY-REST-BUILDER-HASH:1471980905