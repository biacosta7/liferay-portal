...
const NewAIHubNextSteps: React.FC<AIHubNextStepsProps> = ({
	data,
	error,
	isLoading,
}: AIHubNextStepsProps) => {
							...
							description={
								<span className="text-center">
									<p className="mb-1 next-step-page-description">
										Thank you for your purchase of <strong>AI Hub Beta.</strong> An order form
										will be sent to your <strong>email via DocuSign</strong>. Please review,
										sign, and return it to confirm your subscription.
										Once received, we will provision your AI Hub and notify you
										by email when it is ready for use. If the message does not
										appear in your inbox, please check your Spam or Promotions
										folder.
									</p>
									<p className="mt-5">
										Order ID: <span className="next-step-page-text-highlight">{placedOrder?.id}</span>
									</p>
								</span>
							}
							icon={
...
export default NewAIHubNextSteps;
